...
export function landing(o: { version: string; repo: string }) {
  ...
  <a class="brand" href="./" aria-label="Shepherd home">${mark()}<span>shepherd<span class="brand-period">.</span></span></a>
  ...
  <a class="nav-install" href="#start">Get shepherd ${arrow}</a>
  ...
  <nav class="mobile-nav" id="mobile-nav" aria-label="Mobile navigation" hidden><a href="#workflow">The workflow</a><a href="docs/introduction/">Documentation</a><a href="${o.repo}">GitHub</a><a href="#start">Get shepherd</a></nav>
</header>
<main id="main">
<section class="hero">
...
<section class="workflow" id="workflow">
  <div class="section-heading"><p class="eyebrow">01 / FIND YOUR FOCUS</p><div><h2>More agents.<br><span class="muted">Less mental overhead.</span></h2><p>You’re here to build. Shepherd keeps the sessions,<br class="desktop-break"> the signals, and the next move in view.</p></div></div>
  ...
  <div class="feature-pair">
    ...
    <article class="feature-panel continuity"><span class="feature-index">[ 01.3 ] &nbsp; CONTINUITY</span><h3>Close the window.<br>Keep the momentum.</h3><p>A background server keeps your panes running. Detach, reconnect, or pick things up over SSH.</p><div class="continuity-visual"><div class="session-line"><span class="terminal-prompt">~</span><code>shepherd detach</code><span>↗</span></div><div class="session-persistence"><span class="persistence-line"></span><span class="session-live"><span class="status-dot"></span> Session still running</span><span class="persistence-line"></span></div><div class="session-line"><span class="terminal-prompt">~</span><code>shepherd attach</code><span>↵</span></div><div class="restored"><span>✓</span><p>Right where you left off.<small>Same panes. Same conversations.</small></p></div></div><a class="text-link" href="docs/introduction/">Meet the persistent session ${arrow}</a></article>
  </div>
</section>
<section class="start" id="start"><div class="start-heading"><p class="eyebrow">02 / READY WHEN YOU ARE</p><h2>Your next session.<br><em>All together.</em></h2><p>A little setup. A lot less switching.</p><a class="text-link" href="docs/quick-start/">Take the five-minute tour ${arrow}</a><span class="start-platforms">macOS &amp; Linux · Free &amp; open source</span></div><ol class="install-steps"><li><div class="step-title"><span>01</span><h3>Install shepherd</h3></div><div class="install"><span class="prompt">$</span><code>${escape(INSTALL)}</code>${copyButton(INSTALL)}</div></li><li><div class="step-title"><span>02</span><h3>Open a session</h3></div><div class="install"><span class="prompt">$</span><code>shepherd</code>${copyButton("shepherd")}</div></li><li><div class="step-title"><span>03</span><h3>Bring your agents</h3></div><p>Press <kbd>Ctrl+B</kbd> then <kbd>a</kbd> to pick an agent.<br>Or run <code>claude</code> in any pane.</p></li></ol></section>
<section class="closing"><p>Built in the open.<br>Better with your crew.</p><a class="button" href="${o.repo}">Find us on GitHub ${diagonal}</a><span class="closing-wordmark" aria-hidden="true">shepherd<span>.</span></span></section>
</main>`;
}
